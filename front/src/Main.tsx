        ...
        <Router>
          <ThemeProvider theme={theme}>
            ...
            <Routes>
              ...
              />
              <Route path="/EventsInput" element={<EventsInputPage />} />
              <Route path="/HeroInput" element={<HeroInputPage />} />
              <Route path="/EmpHighInput" element={<EmpHighlightInputPage />} />
              <Route path="/NewsInput" element={<NewsInputPage />} />
              <Route path="/NewsInfo" element={<NewsPageMore />} />
              <Route path="/EventReadMore" element={<EventsPageMore />} />
              <Route
                path="/AnnouncementReadMore"
                element={<AnnouncementPageMore />}
              />
              <Route path="/CeoInfo" element={<CeoPageMore />} />
              <Route path="/workspace/dropbox" element={<WPDropBox />} />
              <Route
                path="/workspace/google-drive"
                element={<WPGoogleDrive />}
              />
              <Route path="/Myfiles/" element={<WPOneDrive />} />
              <Route
              ...
              <Route
                ...
                element={<FolderScreen />}
              />
              <Route path="/workspace/drives/sites" element={<SitesScreen />} />
              <Route
              ...
              <Route path="/WorkSpaceOne" element={<WorkspaceToggle />} />
              <Route path="/SecondWorkSpace" element={<SecondWorkSpace />} />
              <Route path="/Policy" element={<SecondWorkSpace />} />
              ...
              <Route path="/recentFilesOneDrive" element={<RecentFiles />} />
              <Route path="/allLinks" element={<AllLinks />} />
              <Route path="/myFilePage" element={<MyFilePage />} />
              <Route path="/MeetingsPage" element={<MeetingsPage />} />
              <Route path="/StarredFile" element={<StarredFile />} />
              <Route path="/SubNews" element={<SubNewss />} />
              <Route path="/MoreNews" element={<MoreNewsPage />} />
              <Route path="/GalleryFolder" element={<ImagesAndVideosPage />} />
              <Route path="/GalleryFolder" element={<ImagesAndVideosPage />} />
              <Route
              ...
              />
              <Route path="/PluginImgVideo" element={<GalleryFolder />} />
              <Route path="/birthday" element={<Birthday />} />
              <Route path="/viewAllEvents" element={<ViewAllEventPage />} />
              <Route path="/heroBannerMore" element={<HeroBannerMore />} />
              <Route
              ...
              <Route
                ...
                element={<HeroBannerMoreImages />}
              />
              <Route path="/heroThumbnail" element={<HeroThumbnail />} />

              <Route
                path="/birthdayContentPage"
                element={<BirthdayContentPage />}
              />
              <Route path="/ceoContentPage" element={<CeoContentPage />} />
              <Route path="/heroContentPage" element={<HeroContentPage />} />
              <Route
              ...
              />
              <Route path="/logoContentPage" element={<LogoContentPage />} />
              <Route
                path="/navigationContentPage"
                element={<NavigationContentPage />}
              />
              <Route path="/newsContentPage" element={<NewsContentPage />} />
              <Route
                path="/policiesContentPage"
                element={<PoliciesContentPage />}
              />
              <Route path="/quickContentPage" element={<QuickContentPage />} />
              <Route path="/documentLibrary" element={<DocumentLibrary />} />
              <Route path="/trash" element={<Trash />} />
              {/* <Route
                              path="/quickLinksPage"
                              element={<QuicklinksPage/>} /> */}
              <Route path="/quickLinksPage" element={<QuickLinkAddPage />} />
              <Route path="/whatsNewAnnounce" element={<WhatsNewAnnounce />} />
              <Route
