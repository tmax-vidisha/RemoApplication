    ...
    if (!text1) {
      try {
        const response = await fetch(
          `https://graph.microsoft.com/v1.0/sites/tmxin.sharepoint.com,39018770-3534-4cef-a057-785c43b6a200,47c126a5-33ee-420a-a84a-c8430a368a43/drives/b!cIcBOTQ170ygV3hcQ7aiAKUmwUfuMwpCqErIQwo2ikN7l5pVNJUCQrB4Gn3-Lhaw/items/root:/${names}:/content`,
          {
            method: "PUT",
            headers: {
      ...
      try {
        const response = await fetch(
          `https://graph.microsoft.com/v1.0/sites/tmxin.sharepoint.com,39018770-3534-4cef-a057-785c43b6a200,47c126a5-33ee-420a-a84a-c8430a368a43/drives/b!cIcBOTQ170ygV3hcQ7aiAKUmwUfuMwpCqErIQwo2ikN7l5pVNJUCQrB4Gn3-Lhaw/items/${text1}:/${names}:/content`,
          {
            method: "PUT",
            headers: {
              Authorization: `Bearer ${token}`,
      ...
      {openPage ? (
        <Box>
          <Grid className={classes.upperPart}>
            ...
            <Grid className={classes.upperGallery}>
              <Grid
              ...
              >
                <Button
                  ...
                  sx={{
                    ...
                    backgroundColor: "#e5f5f7 !important",
                    color: "#18496a",
                  }}
                >
            ...
            {isSuccessItem && (
              <div className={classes.boxContain}>
                {ItemChildren?.response &&
                  ItemChildren?.response?.map((item: any) => {
                    let ext = item.name.split(".").pop();
                    if (ext == item.name) {
                      return (
                        <Box
