    ...
    <AuthenticatedTemplate>
      ...
      <Container className={classes.contentEditorWidth}>
        ...
        <Paper className={classes.cardHeight} elevation={0} sx={{ mb: 3 }}>
          <NationalNews data={data} isLoading={isLoading} error={error} />
        </Paper>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <img
                        ...
                        alt="left"
                        onClick={previous}
                        style={{ cursor: "pointer", color: "#39c8cf" }}
                      />
                      <img
                        src={right}
                        alt="right"
                ...
                <Slider ref={(c) => (slider.current = c)} {...settings}>
                  {data?.response &&
                    data?.response?.map((card, index) => (
                      <div key={index}>
                        <Card
                          sx={{ maxWidth: 250, maxHeight: 260, margin: "5px" }}
                        >
                          <CardActionArea>
                            <CardMedia
        ...
        <Paper className={classes.cardHeight} elevation={0} sx={{ mb: 3 }}>
          <Card elevation={0}>
            <Grid container item xs={12} spacing={0}>
              {/* <Card className={classes.moreNews} sx={{ mb: 3 }} elevation={0}> */}
              {data?.response &&
                  ...
                  return (
                    <>
                      <Grid
                        ...
                        md={3}
                        xs={12}
                        className={classes.newsRightBorder}
                      >
          ...
          {isLoading ? (
            ...
            <>
              <CardContent sx={{ pb: "16px!important" }}>
                ...
                <Slider ref={(c) => (slider1.current = c)} {...settings}>
                  {data?.response &&
                    data?.response?.map((card, index) => (
                      <div key={index}>
                        <Card
                            ...
                            <CardContent>
                              ...
                              >
                                ...
                                <Typography
                                  ...
                                  style={{ color: "#8c8c8c", fontSize: "12px" }}
                                >
                                  {moment(card.fields?.Modified).format("dddd")}{" "}
                                  {moment(card.fields?.Modified).format("DD")}{" "}
                                  {moment(card.fields?.Modified).format("MMM")}{" "}
                                  {moment(card.fields?.Modified).format("YYYY")}
                                </Typography>
