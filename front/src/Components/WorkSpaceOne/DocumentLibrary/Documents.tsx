...
const Documents: React.FC<IFolderProps> = (props: IFolderProps) => {
  const { data, isSuccess, isLoading } = props;
  console.log(data?.response, "Starred documenttttttt library");
                ...
                data?.response
                  ...
                  .map((row: any, index: any) => (
                    ...
                    >
                      ...
                      <TableCell className={classes.TableCell}>
                        {moment(row.lastModifiedDateTime).format("DD-MMM-YYYY")}
                      </TableCell>
                      <TableCell className={classes.TableCell}>
                        {row.size}
                      </TableCell>
