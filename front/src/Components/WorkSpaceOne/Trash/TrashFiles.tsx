...
const TrashFiles: React.FC<IFolderProps> = (props: IFolderProps) => {
  ...
  return (
    <Grid className={classes.bigPart}>
      <Grid className={classes.divText}>Trash</Grid>
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 600 }} aria-label="simple table">
            ...
            <TableBody>
                      ...
                      {userData
                        ...
                        .map((row: any, index: any) => (
                          ...
                          >
                            ...
                            <TableCell className={classes.TableCell}>
                              {row.lastModifiedBy.user.displayName}
                            </TableCell>
                            <TableCell className={classes.TableCell}>
                              {moment(row.lastModifiedDateTime).format(
                                "DD-MMM-YYYY"
                              )}
                            </TableCell>
                            <TableCell className={classes.TableCell}>
                            ...
                            <TableCell className={classes.TableCell}>
                              {moment(row.lastModifiedDateTime).fromNow()}
                            </TableCell>
                            <TableCell className={classes.TableCell}>
                              <Button
                                id="basic-button"
              ...
              >
                <MenuItem onClick={handleClose} className={classes.restoreText}>
                  <img src={restore} alt="" /> <p>Restore</p>
                </MenuItem>
                <MenuItem onClick={handleOpen1} className={classes.restoreText}>
              ...
              >
                <Box sx={style}>
                  ...
                  >
                    Deleting "screen.png" permanently will also delete its
                    activity and history across the workspace. You can't undo
                    this action.
                  </Typography>
