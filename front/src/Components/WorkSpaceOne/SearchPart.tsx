...
const data = [
  ...
  {
    id: 2,
    icon: <img src={word} alt="folder" />,
    label: "Word",
    popup: "Create New Document",
  },
  {
    id: 3,
    icon: <img src={excel} alt="folder" />,
    label: "Excel",
    popup: "Create New Excel File",
  },
  {
    id: 4,
    icon: <img src={pdf} alt="folder" />,
    label: "PDF",
    popup: "Create New PDF",
  },
  {
    id: 5,
    icon: <img src={ppt} alt="folder" />,
    label: "PPT",
    popup: "Create New PPT",
  },
];
...
const SearchPart = (id: any) => {
        ...
        {open &&
          data.map((item) => {
            <Dialog open={open} onClose={handleClose}>
              <DialogTitle>{item.popup}</DialogTitle>
              <DialogContent>
                <TextField
                  autoFocus
                  margin="dense"
  ...
  return (
    <div className={classes.upperSearch}>
      <Grid className={classes.mbSearch}>
