...
const rows = [
  {
    id: 1,
    Title: "Milestone comes as DP World marks a decade of partnership",
    Description:
      "DP World Sokhna  has celebrated its 10th anniversary  by announcing it is near",
    Image: activeView,
    ModifiedOn: "10 months ago",
    IsActive: activeView,
    EnableLikes: "Jon",
    EnableComments: 35,
    ShareAsEmail: "info@gmail.com",
    RecipientEmail: "contact@gmail.com",
  },
  {
    id: 2,
    Title: "Milestone comes as DP World marks a decade of partnership",
