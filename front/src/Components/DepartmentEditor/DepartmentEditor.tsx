...
const columns: GridColDef[] = [
  ...
  { field: "Url", headerName: "Url", type: "text", width: 200 },
...
const DepartmentEditor: React.FC<IFolderProps> = (props: IFolderProps) => {
  ...
  const columns: GridColDef[] = [
    ...
    },
    {
      ...
      renderCell: (params) => (
        <img
          src={params.row.fields.HoverOff}
          alt="jhj"
          style={{ width: "40px", height: "40px" }}
        />
      ),
